...
# Vehicle configs repo — source of telestation YAMLs.
VEHICLE_CONFIGS_ROOT: Path = Path(
    os.environ.get("REE_VEHICLE_CONFIGS", r"C:\__REPOS\ree-vehicle-configs")
)
TELESTATIONS_DIR: Path = VEHICLE_CONFIGS_ROOT / "org" / "vay" / "telestations"
VEHICLES_DIR: Path = VEHICLE_CONFIGS_ROOT / "org" / "vay" / "vehicles"
