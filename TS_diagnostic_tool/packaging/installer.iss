; -----------------------------------------------------------------------
;  TS Diagnostic Tool — Inno Setup script
;
;  Wraps the PyInstaller output (dist\TSDiag) into a Windows installer:
;     - installs to Program Files\TSDiag
...
#define AppName        "TS Diagnostic Tool"
#define AppShortName   "TSDiag"
#define AppVersion     "0.1.0"
#define AppPublisher   "Vay"
#define AppExeName     "TSDiag.exe"
...
OutputBaseFilename=TSDiag-Setup-{#AppVersion}
Compression=lzma2
...
Source: "..\dist\TSDiag\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
