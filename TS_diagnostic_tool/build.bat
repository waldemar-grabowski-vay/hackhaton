@echo off
REM ======================================================================
REM  TS Diagnostic Tool — one-shot Windows build
REM
REM  Produces:
REM     dist\TSDiag\TSDiag.exe       (PyInstaller bundle, ready to run)
REM     dist_installer\TSDiag-Setup-<version>.exe   (Inno Setup installer)
REM
REM  Prereqs:
...
if not exist "%ISCC_EXE%" (
    echo.
    echo PyInstaller bundle is ready at: dist\TSDiag\TSDiag.exe
    echo.
